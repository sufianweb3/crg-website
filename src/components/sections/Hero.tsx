  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden" aria-labelledby="hero-title">
      ...
      <div className="relative z-20 w-full section-container section-padding pt-32 pb-20" role="main">
        <StaggerReveal delay={0} duration={600} tag="div" className="max-w-3xl">
          <h1
            id="hero-title"
        ...
        <StaggerReveal delay={150} duration={500} tag="div" className="max-w-2xl mt-8">
        ...
        <StaggerReveal delay={300} duration={500} tag="div" className="mt-12">
          <a
            href="/get-quote"
